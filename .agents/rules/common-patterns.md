...
description: "Read when choosing an implementation approach or evaluating an external library or template."
---

<!-- Generated by scripts/sync-rules.sh from .claude/rules/common/patterns.md — do not edit. -->
