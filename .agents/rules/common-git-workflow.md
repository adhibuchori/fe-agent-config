...
description: "Read when creating a branch, writing a commit message, or opening a pull request."
---

<!-- Generated by scripts/sync-rules.sh from .claude/rules/common/git-workflow.md — do not edit. -->
