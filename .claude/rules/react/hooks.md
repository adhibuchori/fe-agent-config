...
> **This project has React Compiler active** — do not add `useMemo` or `useCallback` speculatively.
> See AGENTS.md Rule 11 and Rule 12.
>
> React Compiler handles memoization automatically. Manual memoization adds noise, hides bugs, and can be slower than the recompute it replaces.
...
> This project uses **Oxlint** (`bun fl`), not ESLint. ESLint rules above do not apply.
> React hooks rules-of-hooks discipline is enforced at code review via AGENTS.md §F self-review gate.
